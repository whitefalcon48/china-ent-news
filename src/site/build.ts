...
const ABOUT_PROFILE = "中国エンタメニュース収集担当AI・冰糖（ビンタン）と、冰糖日报の運営・情報の扱いについて。";
...
function renderAbout() {
  return `<main class="narrow about"><h1 class="page-title">このサイトについて</h1>
    <section class="about-hero"><div class="about-character"><img src="${href("/assets/bingtang-about-fullbody.png")}" alt="紹介文へ手を差し出す冰糖（ビンタン）の全身イラスト"></div><div class="about-intro"><p class="about-kicker">中国エンタメニュース収集担当AI</p><h2>はじめまして、冰糖（ビンタン）です。</h2><p>私は、中国語圏の映画、ドラマ、俳優、興行、配信、ファン文化に関するニュースを、公式発表や現地媒体などから毎日集めています。</p><p>公式発表を日本語に訳すだけではなく、現地媒体の報じ方、確認できる範囲でのSNSの反応、興行や配信の数字などを見比べながら、「何が起きたのか」「なぜ話題なのか」「どこまで確認できるのか」を日本語で整理します。</p><p>私が集めた情報の中から、記事ごとに気になるポイントや、日本語で読むときに知っておきたい背景をお伝えします。日本ではまだあまり知られていない作品や、小さくても熱量の高い話題も拾っていきます。</p></div></section>
    <section><h2>このサイトの出発点</h2><p>日本語で読める中国エンタメニュースに、出典や現地での受け止めが見えにくいと感じたことから始めた、個人運営のニュースフィードです。公式情報の翻訳だけで終わらず、何が話題になっているのか、その背景まで分かる形を目指しています。</p></section>
    <section><h2>運営について</h2><p>冰糖日报は、AIが情報収集、整理、記事原稿の作成を行う個人運営のニュースフィードです。</p><p>運営者はニュース選定方針の設計とサイト運用を行い、必要に応じて記事の確認や修正をしています。</p><p>ただし、掲載するすべてのニュースについて、人間が裏取りや個別の事実確認を行っているわけではありません。重要な判断に利用する場合は、記事内のリンクから元の情報源をご確認ください。</p></section>
    <section><h2>情報の扱い</h2><ul><li>公式発表、現地媒体、SNS、データは性質の異なる情報として扱います。</li><li>噂やSNS上の反応は事実と区別し、未確認情報を断定しません。</li></ul><p class="about-note">記事は作成時点でAIが取得できた公開情報をもとに生成しており、読み違い、情報の欠落、不正確な記述が含まれる可能性があります。情報の正確性、完全性、最新性を保証するものではありません。</p></section>
...
function renderFooter() {
  return `<footer class="site-footer"><p>冰糖日报（ビンタンデイリー）／記事はAIが収集・生成しています。運営については「このサイトについて」をご覧ください。／© 2026 冰糖日报</p><nav><a href="${href("/about/")}">このサイトについて</a><a href="${href("/archive/")}">アーカイブ</a></nav></footer>`;
}
...
.about{width:min(820px,calc(100% - 28px))}.about section{margin:38px 0}.about h2{font:400 1.16rem/1.55 "Kosugi Maru","Hiragino Maru Gothic ProN",sans-serif;color:var(--navy);margin:0 0 14px}.about p{margin:0 0 14px}.about-hero{display:grid;grid-template-columns:minmax(220px,260px) minmax(0,1fr);align-items:center;gap:30px;position:relative;overflow:hidden;background:linear-gradient(135deg,#FFF 0%,#F0FAFE 100%);border:1px solid var(--line);border-radius:22px;padding:24px 30px 0;box-shadow:0 14px 36px rgba(36,86,119,.08)}.about-hero:before{content:"✦　❄　·　✧";position:absolute;top:12px;right:18px;color:var(--ice);opacity:.2;font-size:24px;letter-spacing:8px}.about-character{align-self:end;min-height:390px;display:flex;align-items:flex-end;justify-content:center}.about-character img{display:block;width:100%;max-width:250px;height:390px;object-fit:contain;object-position:center bottom}.about-intro{position:relative;z-index:1;padding:24px 0 28px}.about-intro .about-kicker{display:inline-block;margin:0 0 10px;border-radius:999px;background:var(--red);color:#fff;padding:4px 12px;font-size:.72rem;font-weight:700;letter-spacing:.04em}.about-intro h2{font-size:1.3rem}.about-intro p:not(.about-kicker){font-size:.93rem}.about ul{margin:0 0 16px;padding-left:1.4em}.about li+li{margin-top:8px}.about-note{border-left:3px solid var(--ice);background:#F7FBFD;border-radius:0 10px 10px 0;padding:13px 15px;font-size:.88rem}.about-contact{background:var(--ice-soft);border-radius:16px;padding:22px 24px}.about-contact a{font-weight:700}.site-footer p{max-width:760px}
@media(max-width:640px){.bingtang-comment{grid-template-columns:78px minmax(0,1fr);gap:10px;padding:12px}.avatar-comment{width:76px;height:76px}.about-hero{grid-template-columns:1fr;gap:0;padding:20px 18px 6px}.about-character{min-height:0}.about-character img{width:230px;height:330px}.about-intro{padding:12px 2px 18px}.about-intro h2{font-size:1.18rem}.about-contact{padding:19px 18px}}
`;
