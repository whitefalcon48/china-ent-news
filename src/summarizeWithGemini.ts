...
- why_it_matters（見出し「ビンタンの注目ポイント」）だけは、docs/editorial-character.md の口調規定に従い、旧「ひとこと」と同じ明るく親しみのあるビンタンの声で書く。

構成ルール:
- lead: 2〜3行。トピック全体として何が起きたか。
- what_happened: 150〜250字。verified_fact claimだけで出来事・数字・日付・関係者を整理。
- why_it_matters: 100〜250字。ビンタンの注目ポイント。旧「ひとこと」と同じ口調で短い感想・リアクションを必ず混ぜる。本文の言い換え・要約をせず、「用語・制度の噛み砕き説明（termsに説明がある場合だけ）」「なぜ今気になるか」「日本語圏から見えにくい点」「次に確認する数字・発表・反応」「これまでの流れとの関係」「情報源の見方・注意点」のうち、この記事に最も価値のある角度を1つ選んで書く。
