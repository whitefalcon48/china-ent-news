...
- 公開記事のビンタンのコメント欄は「ビンタンのひとこと感想」（why_it_matters）の1つだけ。旧「ビンタンからのひとこと」と同じ、明るく親しみのある口調で書く。独立した2つ目のコメント枠は作らない。
- 「ビンタンのひとこと感想」はニュース本文の要約欄ではない。本文に書いてあることを繰り返さず、次のうちその記事で最も価値があるものを選び、前提知識のない読者にも分かる言葉で渡す:
